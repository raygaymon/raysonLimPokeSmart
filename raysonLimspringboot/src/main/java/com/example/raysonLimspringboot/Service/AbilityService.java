...
import com.example.raysonLimspringboot.Model.Abilities;
...
public class AbilityService {
    private static final String APIURL = "https://pokeapi.co/api/v2/ability";

    public JsonObject getAbilityByName (String name){
        ...
        return Abilities.cleanedUpAbiltiyJson(response.getBody());
    }

    public List<String> getAllAbilitiesNameOnly (String limit, String offset){
